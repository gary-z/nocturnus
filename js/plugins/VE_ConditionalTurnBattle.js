...
Imported['VE - Conditional Turn Battle'] = '1.00';
...
/*:
 * ==============================================================================
 * @plugindesc v1.00 - Changes the turn system to one based on individual actions.
 * @author Victor Sant
 *
 * @param = CTB Setup = 
 * @default ======================================
 ...
 * Default: boxHeight - 384 (allows script code)
 * @default boxHeight - 384
 *
 * @param CTB Window Width
 * @desc CTB Window width.
 * Default: 48 + this.maxIcons() * 32 (allows script code)
 * @default 48 + this.maxIcons() * 32
 *
 * @param CTB Window Height
 * @desc CTB Window height.
 * Default: 80 (allows script code)
 * @default 80
 *
 ...
 *
 * @param Show Names
 * @desc Use icons for the battler's display.
 * Default: true
 * @default true
 *
 * @param Names Offset
